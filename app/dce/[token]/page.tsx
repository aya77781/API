    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-6">
        <div className="max-w-md text-center">
          ...
          <p className="text-sm text-gray-500">Veuillez contacter l'expéditeur du dossier de consultation.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-5xl mx-auto px-6 py-5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Image src="/logo.png" alt="API Rénovation" width={48} height={48} className="object-contain" priority />
            <div>
              <h1 className="text-base font-semibold text-gray-900">API Rénovation</h1>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8 space-y-6">
        ...
        {submitted && (
          <div className="bg-green-50 border border-green-200 text-green-800 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-sm">Votre offre a été transmise à API Rénovation.</p>
              <p className="text-xs mt-1 text-green-700">Merci pour votre participation. Nous reviendrons vers vous prochainement.</p>
            </div>
          </div>
        )}
      ...
      <footer className="mt-12 py-6 text-center text-xs text-gray-400 border-t border-gray-200 bg-white">
        © {new Date().getFullYear()} API Rénovation
      </footer>
    </div>
  )
}
