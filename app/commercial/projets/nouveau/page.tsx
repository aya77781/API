...
import { Check, ChevronRight, Upload, X, Plus, Trash2, Search, AlertCircle } from 'lucide-react'
...
function RadioGroup({ options, value, onChange }: { options: string[]; value: string; onChange: (v: string) => void }) {
  ...
  // "Autre à préciser" est selectionne soit si value === 'Autre à préciser', soit si value commence par 'Autre à préciser: '
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <Field label="Programme">
        <CheckboxGroupWithPrecision options={PROGRAMME_OPTIONS} values={data.programme} onChange={v => onChange({ programme: v })} />
      </Field>
