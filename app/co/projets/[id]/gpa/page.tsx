...
export default function GPAPage(_props: PageProps) {
  return (
    <div className="bg-white rounded-lg border border-gray-200 shadow-card p-10 text-center">
      ...
      <h2 className="text-sm font-semibold text-gray-700">Phase GPA</h2>
      <p className="text-xs text-gray-400 mt-2 max-w-sm mx-auto">Suivi désordres GPA, libération cautions</p>
    </div>
  )
}
